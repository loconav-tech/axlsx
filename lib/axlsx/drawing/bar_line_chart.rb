...
module Axlsx
  ...
  class BarLineChart < Chart
    ...
    def add_bar_series(options={})
      BarSeries.new(self, options)
      @series.last
    end

    def add_line_series(options={})
    ...
    def to_xml_string(str = '')
      super(str) do
        ...
        @series.select{|ser| ser.instance_of?(BarSeries)}.each { |ser| ser.to_xml_string(str) }
